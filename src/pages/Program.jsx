    ...
    <main>
        ...
        <section className="section-green">
            ...
            <div className="wadah-card-3">
                <div className="card-fade-gradien">
                    <img src="/src/assets/icon-mipa.svg" alt="Icon" className="icon-gelap" />
                ...
                <div className="card-fade-gradien">
                    <img src="/src/assets/icon-ips.svg" alt="Icon" className="icon-gelap" />
                    <h3>PEMINATAN IPS</h3>
                ...
                <div className="card-fade-gradien">
                    <img src="/src/assets/icon-agama.svg" alt="Icon" className="icon-gelap" />
        ...
        <section className="section-green pt-0">
            ...
            <div className="ekskul-grid">
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Pramuka" /><h4>PRAMUKA</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Paskibraka" /><h4>PASKIBRAKA</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="PMR" /><h4>PMR</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Hadrah" /><h4>HADRAH & QIRAAH</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Tahfidz" /><h4>TAHFIDZ QUR'AN</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Rohis" /><h4>ROHANI ISLAM</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Jurnalistik" /><h4>JURNALISTIK</h4></div>
                <div className="card-ekskul"><img src="/src/assets/gedung.png" alt="Pemrograman" /><h4>PEMROGRAMAN</h4></div>
            </div>
        </section>
    </main>
  );
