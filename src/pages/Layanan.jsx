...
export default function Layanan() {
    ...
    return (
        <>
            {/* ==============================================
                SUNTIKAN SEO KHUSUS HALAMAN LAYANAN
            ============================================== */}
            <Helmet>
                ...
                <meta property="og:description" content="Kami berkomitmen untuk memberikan pelayanan yang transparan, efisien, dan profesional." />
            ...
            <main>
                ...
                <section className="layanan-section hero-pengaduan">
                    <div className="layanan-judul text-center">
                        {/* PERUBAHAN SEO: Ini diubah menjadi <h1> agar Google tahu ini topik utamanya */}
                        <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', margin: '0' }}>LAYANAN PENGADUAN ONLINE</h1>
                    </div>
                ...
                <section className="layanan-section bg-hijau-standar">
                    <div className="layanan-judul text-center">
                        <ScrollReveal>
                            {/* Ini tetap <h2> karena posisinya sebagai sub-judul di bawah Pengaduan */}
                ...
                <section className="layanan-section bg-hijau-gelap">
                    ...
                    <div className="layanan-container align-start">
                        <div className="layanan-kiri img-container">
                            <ScrollReveal>
                                {/* PERUBAHAN SEO: Memperjelas atribut alt pada gambar agar mudah dibaca Google Bot */}
                                <img src="/alurlegalisir.png" alt="Infografis alur layanan legalisir ijazah online di MAN 1 Kota Madiun" className="img-alur" />
                            </ScrollReveal>
                        </div>
