...
export default function Kurikulum() {
  return (
    <>
        {/* ==============================================
            SUNTIKAN SEO KHUSUS HALAMAN KURIKULUM
        ============================================== */}
        <Helmet>
            ...
            <meta property="og:description" content="Pilihan terpadu yang sesuai prospek kerja dan minat bakat siswa. Dilengkapi program Multimedia, Desain Grafis, dan TKJ." />
